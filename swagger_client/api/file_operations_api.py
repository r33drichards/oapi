...
class FileOperationsApi(object):
    ...
    def file_operations_info_post(self, **kwargs):  # noqa: E501
        """Retrieve a file operation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_operations_info_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FileOperationsInfoBody body:
        ...
        if kwargs.get('async_req'):
            return self.file_operations_info_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.file_operations_info_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def file_operations_info_post_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a file operation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_operations_info_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method file_operations_info_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def file_operations_list_post(self, **kwargs):  # noqa: E501
        """List all file operations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_operations_list_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FileOperationsListBody body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.file_operations_list_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.file_operations_list_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def file_operations_list_post_with_http_info(self, **kwargs):  # noqa: E501
        """List all file operations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_operations_list_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method file_operations_list_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def file_operations_redirect_post(self, **kwargs):  # noqa: E501
        """Retrieve the file  # noqa: E501

        Load the resulting file from where it is stored based on the id. A temporary, signed url with embedded credentials is generated on demand.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_operations_redirect_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FileOperationsRedirectBody body:
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.file_operations_redirect_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.file_operations_redirect_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def file_operations_redirect_post_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve the file  # noqa: E501

        Load the resulting file from where it is stored based on the id. A temporary, signed url with embedded credentials is generated on demand.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.file_operations_redirect_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method file_operations_redirect_post" % key
                )
            params[key] = val
        del params['kwargs']
