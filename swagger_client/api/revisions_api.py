...
class RevisionsApi(object):
    ...
    def revisions_info_post(self, **kwargs):  # noqa: E501
        """Retrieve a revision  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revisions_info_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RevisionsInfoBody body:
        ...
        if kwargs.get('async_req'):
            return self.revisions_info_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.revisions_info_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def revisions_info_post_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a revision  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revisions_info_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method revisions_info_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def revisions_list_post(self, **kwargs):  # noqa: E501
        """List all revisions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revisions_list_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RevisionsListBody body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.revisions_list_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.revisions_list_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def revisions_list_post_with_http_info(self, **kwargs):  # noqa: E501
        """List all revisions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.revisions_list_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method revisions_list_post" % key
                )
            params[key] = val
        del params['kwargs']
