...
class EventsApi(object):
    ...
    def events_list_post(self, **kwargs):  # noqa: E501
        """List all events  # noqa: E501

        Events are an audit trail of important events that happen in the knowledge base.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.events_list_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param EventsListBody body:
        ...
        if kwargs.get('async_req'):
            return self.events_list_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.events_list_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def events_list_post_with_http_info(self, **kwargs):  # noqa: E501
        """List all events  # noqa: E501

        Events are an audit trail of important events that happen in the knowledge base.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.events_list_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method events_list_post" % key
                )
            params[key] = val
        del params['kwargs']
