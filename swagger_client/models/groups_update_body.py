...
class GroupsUpdateBody(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """GroupsUpdateBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this GroupsUpdateBody.  # noqa: E501


        :return: The id of this GroupsUpdateBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GroupsUpdateBody.


        :param id: The id of this GroupsUpdateBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this GroupsUpdateBody.  # noqa: E501


        :return: The name of this GroupsUpdateBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GroupsUpdateBody.


        :param name: The name of this GroupsUpdateBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupsUpdateBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupsUpdateBody):
            return False
