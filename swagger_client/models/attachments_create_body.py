...
class AttachmentsCreateBody(object):
    ...
    def __init__(self, name=None, document_id=None, content_type=None, size=None):  # noqa: E501
        """AttachmentsCreateBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this AttachmentsCreateBody.  # noqa: E501


        :return: The name of this AttachmentsCreateBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AttachmentsCreateBody.


        :param name: The name of this AttachmentsCreateBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def document_id(self):
        """Gets the document_id of this AttachmentsCreateBody.  # noqa: E501

        Identifier for the associated document, if any.  # noqa: E501

        :return: The document_id of this AttachmentsCreateBody.  # noqa: E501
        :rtype: str
        """
    ...
    def document_id(self, document_id):
        """Sets the document_id of this AttachmentsCreateBody.

        Identifier for the associated document, if any.  # noqa: E501

        :param document_id: The document_id of this AttachmentsCreateBody.  # noqa: E501
        :type: str
        """
    ...
    def content_type(self):
        """Gets the content_type of this AttachmentsCreateBody.  # noqa: E501


        :return: The content_type of this AttachmentsCreateBody.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this AttachmentsCreateBody.


        :param content_type: The content_type of this AttachmentsCreateBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this AttachmentsCreateBody.  # noqa: E501

        Size of the file attachment in bytes.  # noqa: E501

        :return: The size of this AttachmentsCreateBody.  # noqa: E501
        :rtype: float
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this AttachmentsCreateBody.

        Size of the file attachment in bytes.  # noqa: E501

        :param size: The size of this AttachmentsCreateBody.  # noqa: E501
        :type: float
        """
        if size is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AttachmentsCreateBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachmentsCreateBody):
            return False
