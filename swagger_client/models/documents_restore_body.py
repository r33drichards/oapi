...
class DocumentsRestoreBody(object):
    ...
    def __init__(self, id=None, revision_id=None):  # noqa: E501
        """DocumentsRestoreBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this DocumentsRestoreBody.  # noqa: E501

        Unique identifier for the document. Either the UUID or the urlId is acceptable.  # noqa: E501

        :return: The id of this DocumentsRestoreBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DocumentsRestoreBody.

        Unique identifier for the document. Either the UUID or the urlId is acceptable.  # noqa: E501

        :param id: The id of this DocumentsRestoreBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def revision_id(self):
        """Gets the revision_id of this DocumentsRestoreBody.  # noqa: E501

        Identifier for the revision to restore to.  # noqa: E501

        :return: The revision_id of this DocumentsRestoreBody.  # noqa: E501
        :rtype: str
        """
    ...
    def revision_id(self, revision_id):
        """Sets the revision_id of this DocumentsRestoreBody.

        Identifier for the revision to restore to.  # noqa: E501

        :param revision_id: The revision_id of this DocumentsRestoreBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentsRestoreBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentsRestoreBody):
            return False
