...
class UsersDemoteBody(object):
    ...
    def __init__(self, id=None, to=None):  # noqa: E501
        """UsersDemoteBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._to = None
    ...
    @property
    def id(self):
        """Gets the id of this UsersDemoteBody.  # noqa: E501

        Unique identifier for the user.  # noqa: E501

        :return: The id of this UsersDemoteBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UsersDemoteBody.

        Unique identifier for the user.  # noqa: E501

        :param id: The id of this UsersDemoteBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def to(self):
        """Gets the to of this UsersDemoteBody.  # noqa: E501

        Which role to demote to  # noqa: E501

        :return: The to of this UsersDemoteBody.  # noqa: E501
        :rtype: str
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        """Sets the to of this UsersDemoteBody.

        Which role to demote to  # noqa: E501

        :param to: The to of this UsersDemoteBody.  # noqa: E501
        :type: str
        """
        allowed_values = ["viewer", "member"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UsersDemoteBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UsersDemoteBody):
            return False
