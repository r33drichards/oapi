...
class CollectionsExportAllBody(object):
    ...
    def __init__(self, format=None):  # noqa: E501
        """CollectionsExportAllBody - a model defined in Swagger"""  # noqa: E501
        self._format = None
    ...
    @property
    def format(self):
        """Gets the format of this CollectionsExportAllBody.  # noqa: E501


        :return: The format of this CollectionsExportAllBody.  # noqa: E501
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this CollectionsExportAllBody.


        :param format: The format of this CollectionsExportAllBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectionsExportAllBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectionsExportAllBody):
            return False
