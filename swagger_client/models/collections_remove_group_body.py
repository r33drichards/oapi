...
class CollectionsRemoveGroupBody(object):
    ...
    def __init__(self, id=None, group_id=None):  # noqa: E501
        """CollectionsRemoveGroupBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._group_id = None
    ...
    @property
    def id(self):
        """Gets the id of this CollectionsRemoveGroupBody.  # noqa: E501

        Identifier for the collection  # noqa: E501

        :return: The id of this CollectionsRemoveGroupBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CollectionsRemoveGroupBody.

        Identifier for the collection  # noqa: E501

        :param id: The id of this CollectionsRemoveGroupBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def group_id(self):
        """Gets the group_id of this CollectionsRemoveGroupBody.  # noqa: E501


        :return: The group_id of this CollectionsRemoveGroupBody.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this CollectionsRemoveGroupBody.


        :param group_id: The group_id of this CollectionsRemoveGroupBody.  # noqa: E501
        :type: str
        """
        if group_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectionsRemoveGroupBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectionsRemoveGroupBody):
            return False
