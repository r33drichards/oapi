...
class DocumentsDeleteBody(object):
    ...
    def __init__(self, id=None, permanent=None):  # noqa: E501
        """DocumentsDeleteBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this DocumentsDeleteBody.  # noqa: E501

        Unique identifier for the document. Either the UUID or the urlId is acceptable.  # noqa: E501

        :return: The id of this DocumentsDeleteBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DocumentsDeleteBody.

        Unique identifier for the document. Either the UUID or the urlId is acceptable.  # noqa: E501

        :param id: The id of this DocumentsDeleteBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def permanent(self):
        """Gets the permanent of this DocumentsDeleteBody.  # noqa: E501

        If set to true the document will be destroyed with no way to recover rather than moved to the trash.  # noqa: E501

        :return: The permanent of this DocumentsDeleteBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def permanent(self, permanent):
        """Sets the permanent of this DocumentsDeleteBody.

        If set to true the document will be destroyed with no way to recover rather than moved to the trash.  # noqa: E501

        :param permanent: The permanent of this DocumentsDeleteBody.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentsDeleteBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentsDeleteBody):
            return False
