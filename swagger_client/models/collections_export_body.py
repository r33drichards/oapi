...
class CollectionsExportBody(object):
    ...
    def __init__(self, format=None, id=None):  # noqa: E501
        """CollectionsExportBody - a model defined in Swagger"""  # noqa: E501
        self._format = None
        self._id = None
    ...
    @property
    def format(self):
        """Gets the format of this CollectionsExportBody.  # noqa: E501


        :return: The format of this CollectionsExportBody.  # noqa: E501
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this CollectionsExportBody.


        :param format: The format of this CollectionsExportBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this CollectionsExportBody.  # noqa: E501


        :return: The id of this CollectionsExportBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CollectionsExportBody.


        :param id: The id of this CollectionsExportBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectionsExportBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectionsExportBody):
            return False
