...
class Group(object):
    ...
    def __init__(self, id=None, name=None, member_count=None, created_at=None, updated_at=None):  # noqa: E501
    ...
    def member_count(self):
        ...
        The number of users that are members of the group  # noqa: E501
