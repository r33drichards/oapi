...
class CollectionsRemoveUserBody(object):
    ...
    def __init__(self, id=None, user_id=None):  # noqa: E501
        """CollectionsRemoveUserBody - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._user_id = None
    ...
    @property
    def id(self):
        """Gets the id of this CollectionsRemoveUserBody.  # noqa: E501

        Identifier for the collection  # noqa: E501

        :return: The id of this CollectionsRemoveUserBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CollectionsRemoveUserBody.

        Identifier for the collection  # noqa: E501

        :param id: The id of this CollectionsRemoveUserBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def user_id(self):
        """Gets the user_id of this CollectionsRemoveUserBody.  # noqa: E501


        :return: The user_id of this CollectionsRemoveUserBody.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this CollectionsRemoveUserBody.


        :param user_id: The user_id of this CollectionsRemoveUserBody.  # noqa: E501
        :type: str
        """
        if user_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CollectionsRemoveUserBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectionsRemoveUserBody):
            return False
