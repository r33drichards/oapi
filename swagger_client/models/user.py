...
class User(object):
    ...
    def __init__(self, id=None, name=None, avatar_url=None, email=None, is_admin=None, is_suspended=None, last_active_at=None, created_at=None):  # noqa: E501
    ...
    def is_admin(self):
        ...
        Whether this user has admin permissions.  # noqa: E501
