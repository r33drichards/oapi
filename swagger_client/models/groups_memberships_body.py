...
class GroupsMembershipsBody(Pagination):
    ...
    def __init__(self, query=None, *args, **kwargs):  # noqa: E501
        """GroupsMembershipsBody - a model defined in Swagger"""  # noqa: E501
        self._query = None
    ...
    @property
    def query(self):
        """Gets the query of this GroupsMembershipsBody.  # noqa: E501

        Filter memberships by user names  # noqa: E501

        :return: The query of this GroupsMembershipsBody.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this GroupsMembershipsBody.

        Filter memberships by user names  # noqa: E501

        :param query: The query of this GroupsMembershipsBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupsMembershipsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupsMembershipsBody):
            return False
