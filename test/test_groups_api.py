...
class TestGroupsApi(unittest.TestCase):
    ...
    def test_groups_add_user_post(self):
    ...
    def test_groups_create_post(self):
    ...
    def test_groups_delete_post(self):
    ...
    def test_groups_info_post(self):
    ...
    def test_groups_list_post(self):
    ...
    def test_groups_memberships_post(self):
    ...
    def test_groups_remove_user_post(self):
    ...
    def test_groups_update_post(self):
