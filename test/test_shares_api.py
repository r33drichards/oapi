...
from swagger_client.api.shares_api import SharesApi  # noqa: E501
...
class TestSharesApi(unittest.TestCase):
    ...
    def test_shares_create_post(self):
    ...
    def test_shares_info_post(self):
    ...
    def test_shares_list_post(self):
    ...
    def test_shares_revoke_post(self):
    ...
    def test_shares_update_post(self):
